...
CREATE TABLE IF NOT EXISTS `compte` (
  ...
  `nouveau_mot_de_passe` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `type` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'Utilisateur',
  PRIMARY KEY (`id`)
...
(2, 'test', 'test@gmail.com', '$2y$10$A83OpEXN7jEvCLu.na/cGekwwalXfhn1ZcyhJdqtpzPImhXEujTH6', '2024-04-16 16:30:22', 'Utilisateur');
