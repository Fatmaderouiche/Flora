...
<html>
  ...
  <!-- <div class="product-box">
   ...
   <div class="product-box">
      <div style="background-image:url('../images/marrr.jpg')"></div> 
   ...
   <div class="product-box">
      <div style="background-image:url('../images/mar6.jpg')"></div> 
   ...
   <div class="product-box">
      <div style="background-image:url('../images/mar5.jpg')"></div> 
   ...
   <div class="product-box">
      <div style="background-image:url('../images/original\ bouquet.jpg')"></div> 
